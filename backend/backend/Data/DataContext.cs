...
namespace backend.Data
{
    public class DataContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            var TheaterManagerId = Guid.NewGuid().ToString();
            ...
            string minAge13Id = Guid.NewGuid().ToString();
            string minAge16Id = Guid.NewGuid().ToString();
            string minAge18Id = Guid.NewGuid().ToString();
            ...
            modelBuilder.Entity<movieInformation>().HasData(
                ...
                new movieInformation
                {
                    ...
                    movieImage = "aa.com.vn", // Example byte array
